...
const s = {
  ...
  optionBox: { background: "var(--ff-panel)", border: "1px solid var(--ff-border)", borderRadius: 12, padding: 14 },
  optionLabel: { color: "var(--ff-text-soft)", fontSize: 12, fontWeight: 700, margin: "0 0 10px" },
  ...
  btnSecondary: { background: "var(--ff-panel)", color: "var(--ff-text-soft)", border: "1px solid var(--ff-border)", borderRadius: 12, padding: "12px 18px", fontWeight: 600, fontSize: 14, cursor: "pointer" },
