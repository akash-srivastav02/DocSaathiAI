    ...
    <div style={s.root}>
      ...
      <div style={s.main}>
        ...
        <div style={s.content}>
          ...
          <div style={s.singleBanner}>
            <span style={s.bannerIcon}>{singleFixPlan.icon}</span>
            <div style={{ flex: 1, minWidth: 220 }}>
              <p style={s.singleTitle}>Single Fix - Rs.{singleFixPlan.price} for 1 Download Without Watermark</p>
              <p style={s.singleSub}>Best for one urgent form fix. No credit pack needed, just one clean download when you need it.</p>
            </div>
            <div style={s.singleActionWrap}>
              <span style={s.singleBadge}>ONE-TIME</span>
              <button
                onClick={() => handleBuy(singleFixPlan)}
                disabled={loadingPlan === singleFixPlan.id}
                style={{ ...s.singleBtn, opacity: loadingPlan === singleFixPlan.id ? 0.6 : 1 }}
              >
          ...
          <div>
            ...
            <p style={s.tableSub}>Doc Saathi AI vs Cyber Cafe - Apna Faisla Khud Karo</p>
            <div style={s.table}>
          ...
          <div style={s.cta}>
            <p style={{ color: "#94a3b8", fontSize: 14, margin: 0 }}>Still not sure? Start with Single Fix for one watermark-free download.</p>
            <button onClick={() => handleBuy(singleFixPlan)} style={s.ctaBtn}>Get Single Fix for Rs.{singleFixPlan.price}</button>
          </div>
        </div>
      </div>
    </div>
