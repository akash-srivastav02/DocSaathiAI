...
const PLANS = [
  ...
  },
  {
  ...
  },
    {
      ...
      icon: "PR",
      highlight: true,
      perks: ["100 Final Exports", "Valid 30 Days", "All tool categories", "Best for active users"],
      note: null,
    },
  {
    id: "max",
  ...
  const localizedPlans = PLANS.map((plan) => {
    const localized = {
      ...
      pro: {
        ...
        validity: language === "hi" ? "30 Days" : "30 Days",
        perks: language === "hi" ? ["100 Final Exports", "Valid 30 Days", "All tool categories", "Active users ke liye best"] : ["100 Final Exports", "Valid 30 Days", "All tool categories", "Best for active users"],
      },
      max: {
