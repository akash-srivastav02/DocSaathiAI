export const TOOL_CATEGORIES = [
  ...
  },
  {
    ...
    items: [
      ...
      { id: "split-pdf", label: "Split PDF", route: "/pdf/split", icon: "SP", desc: "Extract exact pages", live: true, accent: "#ef4444" },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "universal-image-converter", label: "Universal Image Converter", route: "/tool/imgconvert", icon: "UC", desc: "PNG, WEBP, HEIC to JPG", live: true, accent: "#10b981" },
      { id: "passport-sheet", label: "Passport Photo Sheet Maker", route: "/tool/passport-sheet", icon: "PS", desc: "Multiple copies on one page", live: true, accent: "#a855f7" },
