...
const s = {
  ...
  sectionLabel: { color: "var(--ff-text-faint)", fontSize: 12, fontWeight: 800, letterSpacing: 1.2, textTransform: "uppercase", marginTop: 4 },
  quickAccess: { display: "grid", gap: 8, padding: "2px 0" },
  quickItem: {
    width: "100%",
    borderRadius: 14,
    border: "1px solid var(--ff-border)",
  ...
  quickItemActive: {
    borderColor: "color-mix(in srgb, var(--ff-blue) 32%, var(--ff-border))",
    background: "color-mix(in srgb, var(--ff-blue) 8%, var(--ff-panel-solid))",
  },
  quickIcon: { minWidth: 30, fontSize: 13, fontWeight: 900 },
  quickText: { fontSize: 15, fontWeight: 700, lineHeight: 1.3 },
  groupWrap: { display: "grid", gap: 10, marginTop: 2 },
  groupCard: { borderRadius: 16, border: "1px solid var(--ff-border)", background: "var(--ff-panel-solid)", overflow: "hidden" },
  groupHead: {
    width: "100%",
    border: "none",
    background: "transparent",
  ...
  groupArrow: { color: "var(--ff-text-faint)", fontWeight: 900, fontSize: 14 },
  ...
  groupItemDisabled: { opacity: 0.56, cursor: "default" },
  groupItemIcon: { minWidth: 24, fontSize: 12, fontWeight: 900 },
  groupItemText: { fontSize: 14, lineHeight: 1.35 },
  logoutBtn: {
    borderRadius: 14,
    border: "1px solid var(--ff-border)",
    background: "var(--ff-panel-solid)",
